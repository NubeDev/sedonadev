...
// int MqttNew.doMqttNewInit_pub()
Cell mqttNew_MqttNew_doMqttNewInit_pub(SedonaVM* vm, Cell* params);

// int MqttNew.doMqttNewPublisherInt()
Cell mqttNew_MqttNew_doMqttNewPublisherInt(SedonaVM* vm, Cell* params);

// int MqttNew.doMqttNewPublisherMsg(int, bool, sys::Str, sys::Str, sys::Str, sys::Str, sys::Str, sys::Str, sys::Str)
Cell mqttNew_MqttNew_doMqttNewPublisherMsg(SedonaVM* vm, Cell* params);

// int[mqttNew::MqttPub.PUB_MAX] MqttNew.doMqttNewNetworkStatus_Pub(int[mqttNew::MqttPub.PUB_MAX])
Cell mqttNew_MqttNew_doMqttNewNetworkStatus_Pub(SedonaVM* vm, Cell* params);

// int MqttNew.doMqttNewInit_sub()
Cell mqttNew_MqttNew_doMqttNewInit_sub(SedonaVM* vm, Cell* params);

// sys::Str MqttNew.doMqttNewSubscriberInt(int)
Cell mqttNew_MqttNew_doMqttNewSubscriberInt(SedonaVM* vm, Cell* params);

// int MqttNew.doMqttNewSubscriberMsg(int, bool, sys::Str, sys::Str, sys::Str, sys::Str, sys::Str, sys::Str, sys::Str)
Cell mqttNew_MqttNew_doMqttNewSubscriberMsg(SedonaVM* vm, Cell* params);

// int[mqttNew::MqttSub.SUB_MAX] MqttNew.doMqttNewNetworkStatus_Sub(int[mqttNew::MqttSub.SUB_MAX])
Cell mqttNew_MqttNew_doMqttNewNetworkStatus_Sub(SedonaVM* vm, Cell* params);

// sys::Str MqttNew.doMqttNewRead_Topic()
Cell mqttNew_MqttNew_doMqttNewRead_Topic(SedonaVM* vm, Cell* params);

// native table for kit 96
NativeMethod kitNatives96[] = 
{
  mqttNew_MqttNew_doMqttNewInit_pub,  // 96::0
  mqttNew_MqttNew_doMqttNewPublisherInt,  // 96::1
  mqttNew_MqttNew_doMqttNewPublisherMsg,  // 96::2
  mqttNew_MqttNew_doMqttNewNetworkStatus_Pub,  // 96::3
  mqttNew_MqttNew_doMqttNewInit_sub,  // 96::4
  mqttNew_MqttNew_doMqttNewSubscriberInt,  // 96::5
  mqttNew_MqttNew_doMqttNewSubscriberMsg,  // 96::6
  mqttNew_MqttNew_doMqttNewNetworkStatus_Sub,  // 96::7
  mqttNew_MqttNew_doMqttNewRead_Topic,  // 96::8
};
...
int isNativeIdValid(int kitId, int methodId)
{
  switch(kitId)
  {
    ...
    case 96:
      ...
      else return kitNatives96[methodId] != NULL;
    default:
       return 0;
  }
}
