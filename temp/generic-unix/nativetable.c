...
// int[mqtt::MQTTPUB.PUB_MAX] MqttDev.doMqttNetworkStatus_Pub(int[mqtt::MQTTPUB.PUB_MAX])
...
// int[mqtt::MQTTSUB.SUB_MAX] MqttDev.doMqttNetworkStatus_Sub(int[mqtt::MQTTSUB.SUB_MAX])
...
NativeMethod kitNatives95[] = 
{
  ...
  mqtt_MqttDev_doMqttNetworkStatus_Pub,  // 95::3
  mqtt_MqttDev_doMqttSubscriberInt,  // 95::4
  mqtt_MqttDev_doMqttSubscriberMsg,  // 95::5
  mqtt_MqttDev_doMqttInit_sub,    // 95::6
  mqtt_MqttDev_doMqttNetworkStatus_Sub,  // 95::7
  mqtt_MqttDev_doMqttRead_Topic,  // 95::8
};
