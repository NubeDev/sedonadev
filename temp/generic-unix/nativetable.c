...
// bool BACnetDev.doBacnetAVNullStatus()
Cell BACnet_BACnetDev_doBacnetAVNullStatus(SedonaVM* vm, Cell* params);

// int BACnetDev.doBacnetAVNullInst()
Cell BACnet_BACnetDev_doBacnetAVNullInst(SedonaVM* vm, Cell* params);
...
NativeMethod kitNatives85[] = 
{
  ...
  BACnet_BACnetDev_doBacnetAVNullStatus,  // 85::25
  BACnet_BACnetDev_doBacnetAVNullInst,  // 85::26
};
...
// int I2cDev.doI2cExit()
Cell i2c_I2cDev_doI2cExit(SedonaVM* vm, Cell* params);
...
// int I2cDev.doI2cSensorReadEnStatus(bool)
Cell i2c_I2cDev_doI2cSensorReadEnStatus(SedonaVM* vm, Cell* params);

// native table for kit 86
NativeMethod kitNatives86[] = 
{
  i2c_I2cDev_doI2cInit,           // 86::0
  i2c_I2cDev_doI2cExit,           // 86::1
  i2c_I2cDev_doI2cRead,           // 86::2
  i2c_I2cDev_doI2cWrite,          // 86::3
  i2c_I2cDev_doI2cSensorReadEnStatus,  // 86::4
};
...
// int MqttDev.doMqttPublisherInt()
Cell mqtt_MqttDev_doMqttPublisherInt(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttPublisherMsg(int, bool, int, sys::Str, sys::Str, int, sys::Str, sys::Str, sys::Str, int)
Cell mqtt_MqttDev_doMqttPublisherMsg(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttInit_pub()
Cell mqtt_MqttDev_doMqttInit_pub(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttNetworkStatus()
Cell mqtt_MqttDev_doMqttNetworkStatus(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttNwErrID()
Cell mqtt_MqttDev_doMqttNwErrID(SedonaVM* vm, Cell* params);

// int[mqtt::MQTTPUB.PUB_MAX] MqttDev.doMqttNwErrID_Obj_Pub(int[mqtt::MQTTPUB.PUB_MAX])
Cell mqtt_MqttDev_doMqttNwErrID_Obj_Pub(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttSubscriberInt(int)
Cell mqtt_MqttDev_doMqttSubscriberInt(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttSubscriberMsg(int, bool, int, sys::Str, sys::Str, int, sys::Str, sys::Str, sys::Str, int)
Cell mqtt_MqttDev_doMqttSubscriberMsg(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttInit_sub()
Cell mqtt_MqttDev_doMqttInit_sub(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttNetworkStatus_Sub()
Cell mqtt_MqttDev_doMqttNetworkStatus_Sub(SedonaVM* vm, Cell* params);

// int MqttDev.doMqttNwErrID_Sub()
Cell mqtt_MqttDev_doMqttNwErrID_Sub(SedonaVM* vm, Cell* params);

// int[mqtt::MQTTSUB.SUB_MAX] MqttDev.doMqttNwErrID_Obj_Sub(int[mqtt::MQTTSUB.SUB_MAX])
Cell mqtt_MqttDev_doMqttNwErrID_Obj_Sub(SedonaVM* vm, Cell* params);

// sys::Str MqttDev.doMqttRead_Topic()
Cell mqtt_MqttDev_doMqttRead_Topic(SedonaVM* vm, Cell* params);

// native table for kit 95
NativeMethod kitNatives95[] = 
{
  mqtt_MqttDev_doMqttPublisherInt,  // 95::0
  mqtt_MqttDev_doMqttPublisherMsg,  // 95::1
  mqtt_MqttDev_doMqttInit_pub,    // 95::2
  mqtt_MqttDev_doMqttNetworkStatus,  // 95::3
  mqtt_MqttDev_doMqttNwErrID,     // 95::4
  mqtt_MqttDev_doMqttNwErrID_Obj_Pub,  // 95::5
  mqtt_MqttDev_doMqttSubscriberInt,  // 95::6
  mqtt_MqttDev_doMqttSubscriberMsg,  // 95::7
  mqtt_MqttDev_doMqttInit_sub,    // 95::8
  mqtt_MqttDev_doMqttNetworkStatus_Sub,  // 95::9
  mqtt_MqttDev_doMqttNwErrID_Sub,  // 95::10
  mqtt_MqttDev_doMqttNwErrID_Obj_Sub,  // 95::11
  NULL,                           // 95::12
  mqtt_MqttDev_doMqttRead_Topic,  // 95::13
};
